...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/api/v1/member/login/**", "/api/v1/member/**").permitAll();
        http.authorizeRequests().antMatchers(HttpMethod.GET, "/api/v1/member/**", "/api/v1/records/**", "/api/v1/workout/**").hasAnyAuthority("USER");
